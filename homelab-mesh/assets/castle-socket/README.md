...
- `castle-socket-preview.png`: both inverse colour treatments.

SVGs use a 64 × 64 viewBox and `currentColor`, with the default colour on the root
element. PNGs are 512 × 512 with transparent backgrounds.

![Castle socket inverse colour preview](castle-socket-preview.png)
